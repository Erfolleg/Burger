...
var accoMenuList = document.querySelector('.menu-accordeon__list');
var accoMenuItem = document.querySelectorAll('.menu-accordeon__item');
var accoMenuItemLength = accoMenuItem.length;
var accoMenuClose = document.querySelector('.menu-accordeon__close');
accoMenuList.addEventListener('click', function (e) {
  for (var i = 0; i < accoMenuItemLength; i++) {
...
var _loop = function _loop(i) {
  accoMenuItem[i].addEventListener('click', function (e) {
    ...
    if (accoMenuItem[i].classList.contains('menu-accordeon__item-active')) {
      ...
      for (var _i = 0; _i < accoMenuItemLength; _i++) {
        accoMenuItem[_i].classList.remove('menu-accordeon__item-active');
      }
...
var itemsCommand = document.querySelectorAll('.team-accordeon__item');
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;

try {
  for (var _iterator = itemsCommand[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var itemCommand = _step.value;
    itemCommand.addEventListener("click", function (e) {
      e.preventDefault();
      var curItemCommand = e.currentTarget;
      ...
      if (curItemCommand.classList.contains('team-accordeon__item-active')) {
        ...
        try {
          for (var _iterator7 = itemsCommand[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
            var elemCommand = _step7.value;
...
$('.player__progress').on('click', function (e) {
  ...
  var newBtnPosition = e.originalEvent.layerX;
  var clickedPersent = newBtnPosition / bar.width() * 100;
  var newPlayerTime = player.getDuration() / 100 * clickedPersent;
...
function onPlayerReady(event) {
  ...
  interval = setInterval(function () {
    var completedTime = player.getCurrentTime();
    var persent = completedTime / durationTime * 100;
...
$('.player__volume-button_icon').on('click', function (e) {
  var btnMute = $('.mute');
  var mute_toggle = $(_this);
...
$('.player__button-play').on('click', function () {
  var playerState = player.getPlayerState(); // 0-ended, 1-played, 2-paused...
...
var buttonsComposition = document.querySelector('.burger__composition');
var composition = document.querySelector('.burger__products');
var closeComposition = document.querySelector('.burger__products-close');
var width = document.body.clientWidth;

if (width <= '768') {
  buttonsComposition.addEventListener('click', function (e) {
    composition.style.display = 'block';
    composition.style.opacity = 1;
  });
  closeComposition.addEventListener('click', function (e) {
...
var placemarks = [{
  ...
  balloonContent: ['<div class="map__balloon">', '<img class="map__balloon-img" src="img/content/burger.png" alt="Бургер"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: ул.50-летия Октября, 3', '</div>']
}, {
  latitude: 54.73827147,
  langitude: 55.98110701,
  hintContent: '<div class="map__hint">ул.50-летия Октября, 21</div>',
  balloonContent: ['<div class="map__balloon">', '<img class="map__balloon-img" src="img/content/burger.png" alt="Бургер"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: ул.50-летия Октября, 21', '</div>']
}, {
  latitude: 54.73220736,
  langitude: 55.95599350,
  hintContent: '<div class="map__hint">ул.Цюрупы, 85</div>',
  balloonContent: ['<div class="map__balloon">', '<img class="map__balloon-img" src="img/content/burger.png" alt="Бургер"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: ул.Цюрупы, 85', '</div>']
}, {
  latitude: 54.73634140,
  langitude: 55.95294556,
  hintContent: '<div class="map__hint">ул.Ленина, 84</div>',
  balloonContent: ['<div class="map__balloon">', '<img class="map__balloon-img" src="img/content/burger.png" alt="Бургер"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: ул.Ленина, 84', '</div>']
}],
    geoObjects = [];
...
function init() {
  ...
  map.geoObjects.add(clusterer); // map.geoObjects.add(placemark);
...
var buttons = document.querySelector('.hamburger-menu-link');
var openMenu = document.querySelector('.humburger-menu');
var closeMenu = document.querySelector('.humburger-menu__close');
...
var closeBtnModal = document.querySelector('.btn-modal');
var formBtn = document.querySelector('.form__row-button');
var formMy = document.querySelector('#order-form');
var popupContentModal = document.querySelector('.popup__content-order');
var overlayOrder = document.querySelector('.overlay-order');
formBtn.addEventListener('click', function (e) {
  e.preventDefault();

  if (validateForm(formMy)) {
    var name = formMy.elements.name.value;
    var phone = formMy.elements.phone.value;
    var comment = formMy.elements.comment.value;
    var to = 'hisaev@gmail.com';
...
var popupReviews = document.querySelector('.popup__reviews');
var popupTitle = document.querySelector('.popup__content-title');
var popupText = document.querySelector('.popup__content-text');
var closePopupRev = document.querySelector('.popup__close-reviews');
var overlay = document.querySelector('.overlay');
reviewsList.addEventListener('click', function (e) {
  var elementRev = e.target;
  var _body = document.getElementsByTagName('body')[0];
  _body.style.overflow = "hidden";

  if (elementRev.tagName === 'A') {
    e.preventDefault();
    var reviewsItem = e.target.closest('.reviews__item');
    var reviewsTitle = reviewsItem.querySelector('.reviews__title').textContent;
    var reviewsText = reviewsItem.querySelector('.reviews__text').textContent;
...
closePopupRev.addEventListener('click', function (e) {
  e.preventDefault();
  popupReviews.style.display = 'none';
  var _body = document.getElementsByTagName('body')[0];
  _body.style.overflow = "visible";
...
var itemsBurger = document.querySelector('.burger__content-list');
var widthContent = document.querySelector('.burger__content');
var rightBtn = document.querySelector('.arrow-scroll__right');
var leftBtn = document.querySelector('.arrow-scroll__left');
var burgerContentItems = document.querySelectorAll('.burger__content-item');
var step = widthContent.offsetWidth;
...
if (step < 1100) {
  ...
  try {
    for (var _iterator6 = burgerContentItems[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var burgerContentItem = _step6.value;
...
var slidesInView = 1;
var maxRight = (itemsBurger.children.length - slidesInView) * step;
var minleft = 0;
var currentStep = 0;
rightBtn.addEventListener('click', function (e) {
  if (currentStep < maxRight) {
    currentStep += step;
    itemsBurger.style.right = "".concat(currentStep, "px");
  } else {
    currentStep = 0;
